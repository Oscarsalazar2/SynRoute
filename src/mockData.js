...
export const mockPassengerNotifications = [
  {
    id: "n1",
    text: "✅ Oscar Salazae ha aceptado tu solicitud de viaje hacia el Tec.",
    time: "Hace 5 min",
    isRead: false,
  },
  {
    id: "n2",
    text: "⚠️ Tu viaje a Plaza Fiesta ha sido cambiado a las 14:30 PM.",
    time: "Hace 1 hora",
    isRead: true,
  },
  {
    id: "n3",
    text: "🔔 Recuerda tener tu identificación universitaria a la mano.",
    time: "Hace 1 día",
    isRead: true,
  },
];
...
export const mockDriverNotifications = [
  {
    id: "n4",
    text: "👤 Tienes 2 nuevas peticiones en tu buzón para tu ruta a las 07:30 AM.",
    time: "Hace 10 min",
    isRead: false,
  },
  {
    id: "n5",
    text: "🌟 Ximena Amador te ha dejado una calificación de 5 estrellas.",
    time: "Hace 2 horas",
    isRead: true,
  },
  {
    id: "n6",
    text: "🎉 ¡Felicidades! Has completado suficientes viajes para ser Conductor Verificado.",
    time: "Hace 1 día",
    isRead: true,
  },
];
