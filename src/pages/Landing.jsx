      ...
      <nav className="navbar glass-panel">
        <div className="container flex items-center justify-between">
          ...
          <div className="navbar-links flex items-center gap-sm">
            ...
            <Link to="/register?role=passenger" className="btn btn-primary">
              Registrarse
            </Link>
          </div>
        </div>
      ...
      <main className="landing-main container text-center">
        <div className="hero-content">
          ...
          <p className="hero-subtitle mb-lg">
            La plataforma segura de carpooling diseñada para facilitar tus
            traslados diarios a la universidad. Ahorra dinero, reduce el tráfico
            y conoce a otros estudiantes.
          </p>
        ...
        <div className="features-grid mt-lg">
          <div className="feature-card glass-panel flex flex-col items-center">
            <div className="feature-icon mb-sm">
              <MapPin size={28} />
            </div>
            <h3>Rutas Personalizadas</h3>
            <p>
              Encuentra viajes que se ajusten perfectamente a tu horario y
          ...
          <div className="feature-card glass-panel flex flex-col items-center">
            ...
            <p>
              Todos los usuarios están verificados con su correo institucional
              del TecNM.
            </p>
          </div>
          <div className="feature-card glass-panel flex flex-col items-center">
            ...
            <p>
              Divide los gastos de gasolina y peajes de manera justa entre todos
              los pasajeros.
            </p>
          </div>
        </div>
